            ...
            <View style={styles.container}>
                ...
                <ScrollView contentContainerStyle={{flexGrow:1}}>
                    ...
                    <View style={{margin:15,flex:1,alignItems:'center'}}>
                        ...
                        <View style={{borderWidth:1,marginBottom:15,width:screenwidth*0.9,borderStyle:'dashed',borderColor:'#22c55e',borderRadius:10}}>
                            <View style={{margin:5}}>
                                <Text style={{fontSize:20,fontFamily:fontBold,color:'#609af8'}}>{t('sumenh')}</Text>
                                <Text style={styles.txt3}>{t('ndsumenh')}</Text>
                            </View>
                        </View>

                        <View style={{borderWidth:1,marginBottom:15,width:screenwidth*0.9,borderStyle:'dashed',borderColor:'#204887',borderRadius:10}}>
                            <View style={{margin:5}}>
                                <Text style={{fontSize:20,fontFamily:fontBold,color:'#609af8'}}>{t('tamnhin')}</Text>
                                <Text style={styles.txt3}>{t('ndtamnhin')}</Text>
                            </View>
                        </View>

                        <View style={{borderWidth:1,marginBottom:15,width:screenwidth*0.9,borderStyle:'dashed',borderColor:'#eec137',borderRadius:10}}>
                            <View style={{margin:5}}>
                                <Text style={{fontSize:20,fontFamily:fontBold,color:'#609af8'}}>{t('giatri')}</Text>
