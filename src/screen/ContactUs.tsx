                            ...
                            <View style={styles.body1}>
                                ...
                                <View style={styles.row}>
                                    <View style={styles.imagerow}>
                                        <View>
                                            <Image source={imageResource.positionicon} style={styles.image2} resizeMode="contain"/>
                                        </View>
                                    </View>
                                ...
                                <View style={styles.row}>
                                    <View style={styles.imagerow}>
                                        <View>
                                            <Image source={imageResource.iconemail} style={styles.image2} resizeMode="contain"/>
                                        </View>
                                    </View>
                                    <View style={styles.txtrow}>
                                ...
                                <View style={styles.row}>
                                    <View style={styles.imagerow}>
                                        <View>
                                            <Image source={imageResource.iconphone} style={styles.image2} resizeMode="contain"/>
                                        </View>
                                    </View>
                                    <View style={styles.txtrow}>
